...
export default async function Page() {
  ...
  return <>
    ...
    <section className="mx-auto max-w-4xl px-5 py-14">
      {products.length ? <AdvertisingRequestForm products={products}/> : <div className="border border-cream/10 bg-white p-8"><h2 className="font-display text-2xl">Advertising requests are temporarily unavailable.</h2><p className="mt-3">Please use the general contact form and select Other.</p><Link href="/contact" className="mt-5 inline-block bg-pine px-5 py-3 font-bold text-cream">Contact us</Link></div>}
